...
- Git (Advanced, Priority: Low)`;
    ...
    runAgent3Btn.addEventListener('click', async () => {
        ...
        setTimeout(async () => {
            ...
            const apiBase = (typeof window !== 'undefined' && window.AIAM_BACKEND_URL) || (typeof localStorage !== 'undefined' && localStorage.getItem('aiam_backend_url')) || '';
            const url = `${apiBase}/api/search?q=${encodeURIComponent(qStr)}&keywords=${encodeURIComponent(kws)}&excludeKeywords=${encodeURIComponent(exKws)}&workModes=${encodeURIComponent(modes)}&employmentTypes=${encodeURIComponent(types)}&city=${encodeURIComponent(city)}&country=${encodeURIComponent(country)}`;
...
Java, Spring Boot, SQL, AWS, Kubernetes, Docker, Git, CI/CD, React, TypeScript, Python`;
            ...
            const apiBase = (typeof window !== 'undefined' && window.AIAM_BACKEND_URL) || (typeof localStorage !== 'undefined' && localStorage.getItem('aiam_backend_url')) || '';
            const searchUrl = `${apiBase}/api/search?q=${encodeURIComponent(qStr)}&keywords=${encodeURIComponent(kws)}&excludeKeywords=${encodeURIComponent(exKws)}&workModes=${encodeURIComponent(modes)}&employmentTypes=${encodeURIComponent(types)}&city=${encodeURIComponent(searchCity)}&country=${encodeURIComponent(searchCountry)}`;
